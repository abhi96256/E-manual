...
const ServiceManagement = () => {
  return (
    <section id="service-request-management">
      ...
      <ul>
        <li><strong>Date Filter:</strong> Users can select a range of dates to display service requests created within that time frame.</li><br />
        <li><strong>Ticket No:</strong> Users can search for a ticket by entering the service ticket number.</li><br />
        <li><strong>Mobile No:</strong> Users can search tickets by entering the mobile number associated with the ticket in the search box.</li><br />
        <li><strong>Category Filter:</strong> Users can filter tickets based on the category assigned to them.</li><br />
        <li><strong>Reported Problem:</strong> Users can filter tickets based on the problem assigned to them.</li><br />
        <li><strong>Service Engineer:</strong> Users can filter tickets based on the service engineer assigned to them.</li><br />
        <li><strong>Extra Filter:</strong> Additional filtering options based on specific criteria like service ticket creation time,
            assign date, resolve date, number, and status of service ticket.</li><br />
        <li><strong>Search Bar:</strong> Allows for quick searching of tickets using keywords (e.g., mobile number, contact name).</li><br />
        <strong><li>Clear All & Search:</li></strong>
        <ul>
          <li><strong>Clear All:</strong> Resets all filters and shows the full list of service tickets.</li><br />
          <li><strong>Search:</strong> Applies the selected filters to refine the service ticket list.</li>
        </ul>
      </ul>
      
      <h3>Assign/Change Engineer</h3>
      <img 
        src={pic1} 
      ...
      />
      <p>
        <h3>Functionality:</h3>  By clicking the plus icon on the right side of an individual ticket, users can open a pop-up window displaying
      ...
      />
      <p>
        <h3>Functionality:</h3> By clicking the Update Contract icon, users can open a dialog or form that allows them to select a new service 
      ...
      />
      <p>
        <h3>Functionality:</h3> By clicking the Duplicate icon, users can open a pop-up that allows them to create a duplicate ticket by
      ...
      />
      <p>
        <h3>Functionality:</h3> By clicking the Reply icon, engineers can open a pop-up window that allows them to reply by selecting a status 
        from the dropdown, specifying the response date, and writing a description of the problem.
      </p>

      <h3>Cancel Request Icon:</h3>
      <img 
        src={pic6}
      ...
      />
      <p>
        <h3>Functionality:</h3> By clicking the Cancel Request icon, users can open a pop-up window that allows them to cancel a service request.
      </p>
      
      <h3>Close Request Icon:</h3>
      <img 
        src={pic7}
      ...
      />
      <p>
        <h3>Functionality:</h3> By clicking the Close Request icon, users can open a pop-up window that allows them to close a service request.
      </p>
    </section>
  );
};
