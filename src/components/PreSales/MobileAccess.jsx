  ...
  return (
    <div id="mobile-access-lead-management">
      <section>
        ...
        <h3>Lead Management on Mobile</h3>
        ...
        />
        <ul>
          <li><strong>Lead Entry:</strong> Users can easily create new leads by filling out essential details, including contact information, lead title, and associated categories such as item groups and competitors.</li><br />
          <li><strong>Lead Listing:</strong> Existing leads are displayed in a clear and organized list, enabling users to quickly access and update any lead details. This list provides essential information at a glance, such as lead status, salesperson, and follow-up dates.</li><br />
          <li><strong>Lead Details & Activity History:</strong> Once a lead is selected, users can view comprehensive details and manage associated activities. The activity history is available in an intuitive format, showing past interactions and upcoming follow-ups, ensuring all activities related to a lead are tracked and accessible.</li>
        </ul>
        ...
        <h3>Success Criteria for Mobile Interface</h3>
        <ul>
      ...
      <section>
        ...
        <ul>
          <li><strong>Detailed History:</strong> When selecting an activity, users can access its full history. This includes all previous interactions, updates, and status changes, providing complete transparency and context for each activity. This feature ensures that users are fully informed of the lead's progress and any actions taken.</li><br />
          <li><strong>Next Action:</strong> The mobile interface allows users to perform the next necessary action on an activity directly. Options like "Close," "Reschedule," "Transfer," and "Follow Up" are available, making it easy to update the status or plan the next steps for each activity.</li>
        </ul>
        ...
        <h3>Success Criteria for Activity Management</h3>
        <ul>
      ...
      <section>
        <h2>Activity Location Tracking</h2>
        ...
        />
        <ul>
          <li><strong>Start of the Meeting:</strong> The location is recorded at the moment the user marks the meeting as started. This ensures that the precise location where the meeting begins is documented.</li><br />
          <li><strong>End of the Meeting:</strong> Similarly, when the meeting is marked as finished, the system captures the location again. This provides a complete record of where the meeting concluded.</li>
        </ul>
