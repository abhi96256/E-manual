  ...
  return (
    <div id="mobile-access-lead-management">
      <section>
        ...
        />
        <ul>
          <li><strong style={headingStyle}>Lead Entry:</strong> Users can easily create new leads by filling out essential details, including contact information, lead title, and associated categories such as item groups and competitors.</li><br />
          <li><strong style={headingStyle}>Lead Listing:</strong> Existing leads are displayed in a clear and organized list, enabling users to quickly access and update any lead details. This list provides essential information at a glance, such as lead status, salesperson, and follow-up dates.</li><br />
      ...
      <section>
        ...
        />
        <ul>
          <li><strong style={headingStyle}>Start of the Meeting:</strong> The location is recorded at the moment the user marks the meeting as started. This ensures that the precise location where the meeting begins is documented.</li><br />
