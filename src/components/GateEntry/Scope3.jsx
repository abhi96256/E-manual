...
const Scope = () => {
  return (
    <div>
      ...
      <p>
        This document provides a comprehensive guide to the <strong>Gate Entry & Visitor Pass</strong> module within the 
       <strong> Inventory Movement and Management (IMM) </strong>system at 3S Logics Pvt. Ltd. The primary objective is 
      ...
      <h3>The scope of this document includes the following sections:</h3>
      <h4>1. Overview of the System:</h4>
      <ul>
        <li>
          A detailed description of the <strong>Gate Entry & Visitor Pass</strong> module’s purpose, objectives, and 
      ...
      <h4>2. Visitor Entry Registration:</h4>
      <ul>
        <li>
          <strong>Quick and Hassle-Free Registration:</strong> Streamline the process for registering visitors 
          by capturing essential details such as name, contact number, organization, and reason for the visit.
        </li>
        <li>
          <strong>Link Visitors to Employees or Departments:</strong> Ensure accountability by linking each 
          visitor to a specific employee or department, providing traceability for all visitors within the premises.
        </li>
      </ul>
      <h4>3. Vehicle Entry and Inventory Management:</h4>
      <ul>
        <li>
          <strong>Vehicle Details Recording:</strong> Record vehicle-specific information, including vehicle number, 
          entry status (empty or loaded), and the purpose of entry (e.g., delivery, service, etc.).
        </li>
        <li>
          <strong>Tracking Inventory Movements:</strong> Monitor inventory associated with vehicles, ensuring that 
          goods entering or exiting the premises are accurately logged and verified against relevant records.
        </li>
        <li>
          <strong>Vehicle Weight Capture:</strong> Capture vehicle weight (loaded and unloaded) at entry and exit 
          points for reconciliation and auditing purposes, ensuring accurate reporting.
        </li>
      </ul>
      <h4>4. Gate Pass Generation:</h4>
      <ul>
        <li>
          <strong>Secure Pass Generation:</strong> Generate gate passes for visitors, vehicles, and inventory, 
        ...
        <li>
          <strong>Digital and Physical Formats:</strong> Provide passes in both digital and physical formats, enabling 
          flexibility and ease of access management, while ensuring compatibility with different operational needs.
        </li>
      </ul>
      <h4>5. Real-Time In/Out Time Logging:</h4>
      <ul>
        <li>
          <strong>Automated Entry and Exit Logs:</strong> Automatically record the entry and exit times for visitors, 
      ...
      <h4>6. Integrated Search and Filter Tools:</h4>
      <ul>
        <li>
          <strong>Advanced Search and Sorting:</strong> Enable users to search, sort, and filter records based on various 
        ...
        <li>
          <strong>Improved Data Accessibility:</strong> This functionality enhances the ability to retrieve data 
          quickly for auditing, reporting, or operational reviews, ensuring that stakeholders have 
          easy access to accurate records.
        </li>
      </ul>
      <h4>7. Inventory Movement Monitoring:</h4>
      <ul>
        <li>
          <strong>Clear Record of Inventory Movement:</strong> Track and log inventory movements tied to vehicle 
        ...
        <li>
          <strong>Unauthorized Movement Prevention:</strong> Prevent unauthorized inventory movements by linking 
          each item with verified vehicles or visitors, reinforcing security measures within the organization.
        </li>
      </ul>
      <h4>8. Centralized Dashboard and Reports:</h4>
      <ul>
        <li>
          <strong>Unified Dashboard:</strong> Provide a centralized dashboard that gives real-time tracking of visitor 
        ...
        <li>
          <strong>Comprehensive Reporting:</strong> Generate detailed reports on inventory reconciliation, vehicle 
      ...
      <ul>
        <li>
          <strong>Enhanced Security:</strong> The system ensures that only authorized visitors, vehicles, and inventory 
        ...
        <li>
          <strong>Improved Operational Efficiency:</strong> By automating visitor registration, vehicle entry management, 
        ...
        <li>
          <strong>Accurate Record Keeping:</strong> The system captures and maintains accurate, real-time records 
        ...
        <li>
          <strong>Ease of Access and Use:</strong> The intuitive user interface, coupled with integrated search and filter 
        ...
        <li>
          <strong>Compliance and Accountability:</strong> The system ensures compliance with internal security and 
        ...
        <li>
          <strong>Real-Time Monitoring:</strong> The system allows for real-time monitoring of visitor and vehicle 
      ...
      <h3>Summary</h3>
      <p>
        The <strong>Gate Entry & Visitor Pass</strong> module within the<strong> Inventory Movement and Management (IMM) </strong>system at 
